      ...
      <View style={{
        ...
        <View style={{ width: '80%', justifyContent: 'center' }}>
          ...
          <Text style={{
            ...
            marginBottom: 5,
            textAlign: 'center',
          }}>CIGARRO PREMIER SELECT X 20 UN</Text>
        ...
        <View style={{ width: '80%', justifyContent: 'center', display: 'flex', flexDirection: 'row' }}>
          <TouchableOpacity style={{
            ...styles.logBtn,
            width: '30%',
            height: 50,
        ...
        <View style={{ width: '80%' }}>
          <Text style={{ fontSize: 18, marginTop: 5 }}>Cantidad Prod Grabados: 2.0</Text>
          <Text style={{ fontSize: 18, marginTop: 5 }}>Cantidad de Scan Realizados: 2</Text>
        </View>
      </View>
