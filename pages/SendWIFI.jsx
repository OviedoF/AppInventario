            ...
            <View style={styles.container}>
                ...
                <View>
                    ...
                    <View style={[styles.flex_row]}>
                        ...
                        <TouchableOpacity style={[styles.primaryBtn, {marginLeft: 10, width: '40%'}]}>
                            <Text style={[styles.white, {fontWeight: 'bold', textAlign: 'center'}]}>
                                ENVIAR
                            </Text>
                        </TouchableOpacity>
                    </View>

                    <TouchableOpacity style={[styles.primaryBtn, {marginTop: 10, width: '100vw'}]}>
                        <Text style={[styles.white, {fontWeight: 'bold', textAlign: 'center'}]}>
                            ENVIAR PENDIENTES
                        </Text>
                    </TouchableOpacity>
